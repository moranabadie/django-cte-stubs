...
reveal_type(totals.join(Order, region=totals.col.region_id, _join_type=LOUTER))
reveal_type(totals.join(Order, region=totals.col.region_id, _join_type=LOUTER).annotate(region_total=totals.col.total))
...
reveal_type(orders.get().region_total)
